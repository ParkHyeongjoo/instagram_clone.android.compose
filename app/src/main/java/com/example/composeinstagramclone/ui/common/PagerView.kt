...
fun PagerView(
    ...
    HorizontalPager(
        ...
        when(page) {
            0 -> AllTabScreen(rowList = rowList, columnWidth = columnWidth)
            1 -> ReelsTabScreen(rowList = rowList, columnWidth = columnWidth)
            2 -> TagTabScreen(rowList = rowList, columnWidth = columnWidth)
        }
    }
}